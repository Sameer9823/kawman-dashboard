...
const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': [
    ...
    "connect-src 'self' https://tile.openstreetmap.org https://api.resend.com https://api.cloudinary.com https://api.assemblyai.com https://generativelanguage.googleapis.com https://api.openai.com wss:",
